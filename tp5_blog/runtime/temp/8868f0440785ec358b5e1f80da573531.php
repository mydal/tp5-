<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\author\add.html";i:1583805104;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583802952;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">新增新闻作者</span>
                            </div>
                                    ...
                                    <form class="form-horizontal" role="form" action="add" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">添加新闻作者信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
