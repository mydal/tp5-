<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\news\lists.html";i:1583843328;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583808925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加新闻" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href ='<?php echo url('news/add'); ?>'"> <i class="fa fa-plus"></i> 添加
                </button>
                <button type="submit" tooltip="删除新闻" class="btn btn-danger btn-sm shi"
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $value['news']['tagname']; ?></td>
                                            <td class="text-center"><?php echo $value['status']; ?></td>
                                            <td class="text-center"><?php echo $value['newss']['name']; ?></td>
