<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\tags\edit.html";i:1583803257;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583802952;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">更新新闻类别</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('tags/edit'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="tagname" placeholder="" name="tagname"
                                                       required="" type="text" value="<?php echo $model['tagname']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新新闻类别信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
