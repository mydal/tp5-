<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\admin\edit.html";i:1583635607;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583808925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form class="form-horizontal" role="form" action="<?php echo url('admin/edit'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="username"
                                                       required="" type="text" value="<?php echo $model['username']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="status" id="" class="form-control">
                                                    <option value="0" <?php if($model['status'] == '启用'): ?> selected <?php endif; ?>>启用</option>
                                                    <option value="1" <?php if($model['status'] == '禁用'): ?> selected <?php endif; ?>>禁用</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新管理员信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
