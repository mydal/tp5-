<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\article\edit.html";i:1583744704;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583808925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">更新物资</span>
                            </div>
                                    ...
                                    <form class="form-horizontal" role="form" action="<?php echo url('article/edit'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="price" placeholder="" name="price"
                                                       required="" type="text" value="<?php echo $model['price']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="num" placeholder="" name="num"
                                                       required="" type="text" value="<?php echo $model['num']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="address" placeholder="" name="address"
                                                       required="" type="text" value="<?php echo $model['address']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                            ...
                                            <div class="col-sm-6">
                                                <select name="status" id="" class="form-control">
                                                    ...
                                                    <option value="0" <?php if($model['status'] == '已投入使用'): ?> selected <?php endif; ?>>已投入使用</option>
                                                    <option value="1" <?php if($model['status'] == '未投入使用'): ?> selected <?php endif; ?>>未投入使用</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新物资信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
