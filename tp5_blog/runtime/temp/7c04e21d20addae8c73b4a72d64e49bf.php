<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\author\edit.html";i:1584067896;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583808925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('author/lists'); ?>">新闻作者管理</a>
                    </li>
                    <li class="active">更新新闻作者</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">更新新闻作者</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('author/edit'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="catename"
                                                   class="col-sm-2 control-label no-padding-right">新闻作者名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="tagname" placeholder="" name="name"
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">新闻作者缩略图</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">新闻作者性别</label>
                                            <div class="col-sm-6">
                                                <select name="sex" id="" class="form-control">
                                                    <option value="" selected>请选择</option>
                                                    <option value="0" <?php if($model['sex'] == '男'): ?>selected <?php endif; ?>>男</option>
                                                    <option value="1" <?php if($model['sex'] == '女'): ?> selected <?php endif; ?>>女</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新新闻作者</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
