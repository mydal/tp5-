<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\article\lists.html";i:1583843328;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583808925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加物资" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href ='<?php echo url('article/add'); ?>'"> <i class="fa fa-plus"></i> 添加
                </button>
                <button type="submit" tooltip="删除物资" class="btn btn-danger btn-sm shi"
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">物资数量</th>
                                            <th class="text-center">物资图片</th>
                                            <th class="text-center">物资捐赠方</th>
                                            <th class="text-center">物资类别</th>
                                            <th class="text-center">物资简介</th>
                                            <th class="text-center">物资状态</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img src="<?php echo $value['pic']; ?>" alt="" height="40px"></td>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url('article/del',array('id'=>$value['id'])); ?>')"
