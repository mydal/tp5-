<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\mcate\edit.html";i:1583546663;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583506676;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="main-container container-fluid">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                <li>
                    <a href="<?php echo url('ncate/lists'); ?>">
                                    <span class="menu-text">
                                        新闻类别列表                                    </span>
                        <i class="menu-expand"></i>
                    </a>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('Mcate/lists'); ?>">物质类别管理</a>
                    </li>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">更新物质类别</span>
                            </div>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('mcate/edit'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="catename"
                                                   class="col-sm-2 control-label no-padding-right">物质类别名称</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新物资类别信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
