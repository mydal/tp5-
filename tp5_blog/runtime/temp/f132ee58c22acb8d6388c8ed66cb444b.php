<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\tags\lists.html";i:1583843438;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583808925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加新闻类别" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('tags/add'); ?>'"><i class="fa fa-plus"></i> 添加
                </button>
                <button type="submit" tooltip="删除新闻类别" class="btn btn-danger btn-sm shi"
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">新闻类别名称</th>
                                            <th class="text-center">新闻类别图片</th>
                                        ...
                                        <form class="piliangshanchan">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $value['tagname']; ?></td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗', '<?php echo url('tag/del',array('id'=>$value['id'])); ?>')"
