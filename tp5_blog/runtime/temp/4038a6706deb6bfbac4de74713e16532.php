<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\xampp\htdocs\tp5_blog\public/../application/admin\view\news\edit.html";i:1583806973;s:63:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\top.html";i:1583543949;s:64:"F:\xampp\htdocs\tp5_blog\application\admin\view\common\left.html";i:1583808925;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('news/lists'); ?>">新闻管理</a>
                    </li>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">更新新闻</span>
                            </div>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('news/edit'); ?>" method="post"  enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="username"
                                                   class="col-sm-2 control-label no-padding-right">新闻名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="name"
                                                       required="" type="text" value="<?php echo $model['name']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">新闻缩略图</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">新闻状态</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">新闻分类</label>
                                            <div class="col-sm-6">
                                                <select name="tag_id" id="">
                                                    <option value="">---请选择</option>
                                                    <?php foreach($m as  $value): ?>
                                                    <option value="<?php echo $value['id']; ?>" <?php if($model['tag_id'] == $value['id']): ?> selected <?php endif; ?>><?php echo $value['tagname']; ?></option>
                                                    <?php endforeach; ?>
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">新闻作者</label>
                                            <div class="col-sm-6">
                                                <select name="author_id" id="">
                                                    <option value="">---请选择</option>
                                                    <?php foreach($models as $value): ?>
                                                    <option value="<?php echo $value['id']; ?>" <?php if($model['author_id'] == $value['id']): ?> selected <?php endif; ?>><?php echo $value['name']; ?></option>
                                                    <?php endforeach; ?>
                                        ...
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">新闻简介</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="username"
                                                   class="col-sm-2 control-label no-padding-right">新闻详情</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新新闻</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
