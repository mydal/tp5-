<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"F:\xampp\htdocs\shop\public/../application/admin\view\rbac\add_administrator.html";i:1584599673;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <form action="" method="post" class="form form-horizontal">
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <input type="text" class="input-text" value="" placeholder="" name="username" datatype="*"
                       nullmsg="用户名不能为空！">
        ...
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <input type="password" class="input-text" value="" placeholder="" name="password" datatype="*"
                       nullmsg="密码不能为空！">
                <span class="Validform_checktip"></span>
            </div>
        </div>
