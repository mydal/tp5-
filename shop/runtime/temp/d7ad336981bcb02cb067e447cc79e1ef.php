<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"F:\xampp\htdocs\shop\public/../application/admin\view\recommend\index.html";i:1584664989;}*/ ?>
<!-- <!DOCTYPE html> -->
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="crumbs">
    ...
    <ul>
        <li>
            <a class="active" href="javascript:;">推荐位列表</a>
        </li>
    </ul>
</div>
    ...
    <div class="administrator">
        <div class="d_Confirm_Order_style">
            <div class="border clearfix">
                <span class="l_f">
                    <a href="<?php echo url('recommend/add'); ?>" class="btn btn-warning"><i
                            class="fa fa-plus"></i> 添加推荐位</a>
                ...
                <div class="table_menu_list">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th width="80px">编号</th>
                            <th width="180px">推荐位名称</th>
                            <th width="180px">推荐位状态</th>
                            <th width="180px">推荐位缩略图</th>
                        ...
                        <form class="piliangshanchan">
                            ...
                            <tr>
                                ...
                                <td><span class="label label-success radius"><?php echo $value['status']; ?></span></td>
                                <td><img src="/uploads/product/<?php echo $value['image_thumb']; ?>" alt=""></td>
...
<script type="text/javascript">
    ...
    function delAll() {
        layer.confirm('确认要删除吗？', function (index) {
            if ($('.cheidbox').is(':checked')) {
                $.ajax({
                    url: "<?php echo url('recommend/delAll'); ?>",
    ...
    $('.del').on('click', function () {
        ...
        layer.confirm('你真的要删除吗?', {icon: 3}, function () {
            $.ajax({
                url: "<?php echo url('recommend/del'); ?>",
                type: 'post',
                data: {
                    'id': id
                },
