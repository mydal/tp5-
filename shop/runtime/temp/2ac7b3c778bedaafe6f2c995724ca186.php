<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"F:\xampp\htdocs\shop\public/../application/index\view\index\login.html";i:1584698299;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0032)http://www.52minq.com/login.html -->
...
<header>
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <div id="logo">
                    <a href="http://www.52minq.com/login.html">
...
<div class="container">
    <ul class="breadcrumb">
        <li>
            <a href="http://www.52minq.com/login.html"> <i class="fa fa-home"></i>
            </a>
        </li>
        <li>
            <a href="http://www.52minq.com/login.html">账户</a>
        </li>
        <li>
            ...
            <div class="row">
                    ...
                    <div class="well">
                        ...
                        <p><strong>如果您已经是本站会员，请直接登录。</strong>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="" placeholder="邮箱地址" id="email"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="well">
                        ...
                        <a href="<?php echo url('index/register'); ?>" class="btn btn-primary">继续</a>
                    </div>
                </div>
            </div>
        </div>
