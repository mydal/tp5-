<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"F:\xampp\htdocs\shop\public/../application/admin\view\rbac\role.html";i:1584843356;}*/ ?>
<!-- <!DOCTYPE html> -->
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="administrator">
        <div class="d_Confirm_Order_style">
            <div class="border clearfix">
                <span class="l_f">
                    <a href="<?php echo url('rbac/addrole'); ?>" class="btn btn-warning"><i
                ...
                <div class="table_menu_list">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th width="80px">编号</th>
                            <th width="250px">角色名</th>
                            <th width="70px">中文名</th>
                        ...
                        <form class="piliangshanchan">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="编辑" href="<?php echo url('editerole',['id'=>$value['id']]); ?>"
    ...
    function delAll() {
        layer.confirm('确认要删除吗？', function (index) {
            if ($('.cheidbox').is(':checked')) {
                $.ajax({
                    url: "<?php echo url('Rbac/delRoleAll'); ?>",
