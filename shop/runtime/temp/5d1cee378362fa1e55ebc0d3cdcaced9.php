<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"F:\xampp\htdocs\shop\public/../application/admin\view\product\index.html";i:1584599672;}*/ ?>
<!-- <!DOCTYPE html> -->
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="administrator">
        <div class="d_Confirm_Order_style">
            <div class="border clearfix">
                <span class="l_f">
                    <a href="<?php echo url('product/add'); ?>" class="btn btn-warning"><i
    ...
    function delAll() {
        layer.confirm('确认要删除吗？', function (index) {
            if ($('.cheidbox').is(':checked')) {
                $.ajax({
                    url: "<?php echo url('Product/delAll'); ?>",
