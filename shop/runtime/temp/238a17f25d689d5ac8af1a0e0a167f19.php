<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"F:\xampp\htdocs\shop\public/../application/admin\view\recommend\add.html";i:1584666019;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="type_style">
    <div class="crumbs">
        <ul>
            <li>
                <a href="<?php echo url('recommend/index'); ?>">推荐位列表</a>
            </li>
            <li class="uline">/</li>
            <li>
                <a class="active" href="javascript:;">添加推荐位</a>
            </li>
        </ul>
    </div>
    <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
        ...
        <div class="Operate_cont clearfix">
            <label class="form-label">上传推荐位图片：</label>
            <div class="formControls ">
