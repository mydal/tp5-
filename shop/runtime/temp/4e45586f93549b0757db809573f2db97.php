<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"F:\xampp\htdocs\shop\public/../application/admin\view\rotation\index.html";i:1584604874;}*/ ?>
<!-- <!DOCTYPE html> -->
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="crumbs">
    ...
    <ul>
        <li>
            <a class="active" href="javascript:;">轮播图列表</a>
        </li>
    </ul>
</div>
    ...
    <div class="administrator">
        <div class="d_Confirm_Order_style">
            <div class="border clearfix">
                <span class="l_f">
                    <a href="<?php echo url('rotation/add'); ?>" class="btn btn-warning"><i
                            class="fa fa-plus"></i> 添加轮播图</a>
                ...
                <div class="table_menu_list">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th width="80px">编号</th>
                            <th width="180px">轮播图名称</th>
                            <th width="180px">轮播图状态</th>
                            <th width="180px">轮播图缩略图</th>
    ...
    function delAll() {
        layer.confirm('确认要删除吗？', function (index) {
            if ($('.cheidbox').is(':checked')) {
                $.ajax({
                    url: "<?php echo url('rotation/delAll'); ?>",
