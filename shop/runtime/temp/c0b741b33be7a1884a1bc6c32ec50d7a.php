<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"F:\xampp\htdocs\shop\public/../application/admin\view\rbac\administrator.html";i:1584599673;}*/ ?>
<!-- <!DOCTYPE html> -->
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="page-content clearfix">
    <div class="administrator">
        <div class="d_Confirm_Order_style">
            <form action="<?php echo url('rbac/administrator'); ?>" method="post">
                <div class="search_style">
                    <ul class="search_content clearfix">
                        <li>
                            <label class="l_f">登录名名称:</label>
                            <input name="username" type="text" class="text_add" placeholder=""/>
                        </li>
                        <li>
            ...
            <div class="border clearfix">
                <span class="l_f">
                    <a href="<?php echo url('rbac/addAdministrator'); ?>" class="btn btn-warning"><i
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <form class="piliangshanchan">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="编辑" href="<?php echo url('editeadministrator',['admin_id'=>$value['admin_id']]); ?>"
                                       class="btn btn-xs btn-info">
                                        <i class="fa fa-edit bigger-120"></i>
                                    </a>
                                    <a title="删除" data-id="<?php echo $value['admin_id']; ?>" href="javascript:;"
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="dataTables_info"><?php echo $model->render(); ?></div>
                </div>
                <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    $('.del').on('click', function () {
        var admin_id = $(this).data('id');  //获取自定义属性id
        var that = $(this);  //改变this指向

        layer.confirm('你真的要删除吗?', {icon: 3}, function () {
            $.ajax({
                url: "<?php echo url('Rbac/delAdministrator'); ?>",
                type: 'post',
                data: {
                    'admin_id': admin_id
                },
