<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"F:\xampp\htdocs\shop\public/../application/admin\view\product\edite.html";i:1584669374;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <input type="text" class="input-text" name="title" value="<?php echo $model['title']; ?>">
        ...
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <input type="text" class="input-text" name="quantity" value="<?php echo $model['quantity']; ?>">
                <span class="Validform_checktip"></span>
            </div>
        </div>
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <input type="text" class="input-text" name="minmum" value="<?php echo $model['minmum']; ?>">
                <span class="Validform_checktip"></span>
            </div>
        </div>
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <input type="text" class="input-text" name="price" value="<?php echo $model['price']; ?>">
                <span class="Validform_checktip"></span>
            </div>
        </div>
        ...
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <select name="category_id" id="">
                    ...
                    <option value="<?php echo $item['id']; ?>" <?php if($model['category_id'] == $item['id']): ?> selected <?php endif; ?>><?php echo $item['title']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
