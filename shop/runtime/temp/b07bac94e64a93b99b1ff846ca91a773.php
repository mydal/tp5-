<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"F:\xampp\htdocs\shop\public/../application/admin\view\rbac\edite_rule.html";i:1584599673;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="type_style">
    <div class="crumbs">
        <ul>
            ...
            <li class="uline">/</li>
            <li>
                <a class="active" href="javascript:;">更新规则</a>
            </li>
        </ul>
    </div>
    <form action="<?php echo url('rbac/editerule'); ?>" method="post" class="form form-horizontal">
        <div class="Operate_cont clearfix">
            <label class="form-label">角色名：</label>
            <div class="formControls ">
                <input type="text" class="input-text" value="<?php echo $rule['name']; ?>" placeholder="" name="name" datatype="*"
                       nullmsg="角色名不能为空！">
        ...
        <div class="Operate_cont clearfix">
            ...
            <div class="formControls ">
                <input type="text" class="input-text" value="<?php echo $rule['title']; ?>" placeholder="" name="title" datatype="*"
                       nullmsg="角色中文名不能为空！">
                <span class="Validform_checktip"></span>
            </div>
        </div>
